    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0"><i class="bi bi-plus-circle"></i> Crea Nuova Sala</h4>
            </div>
            <div class="card-body">
                <?php if (!empty($error)): ?>
                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3"
                                  placeholder="Descrizione della sala..."><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="amenities" name="amenities" rows="3"
                                  placeholder="Es: Proiettore, Wi-Fi, Lavagna..."><?= htmlspecialchars($_POST['amenities'] ?? '') ?></textarea>
                        <div class="form-text">Elenca i servizi separati da virgola.</div>
                    </div>

                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="/rooms/admin.php" class="btn btn-secondary me-md-2">Annulla</a>
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> Crea Sala
                        </button>
                    </div>
                </form>
            </div>
